...
class WgetArgs(object):
    def realize(self, item):
        ...
        skipped = requests.get('https://raw.githubusercontent.com/ArchiveTeam/gov-ftp-items/master/skipped_sites')
...
project = Project(
    ...
    project_html="""
        ...
        <h2>FTP <span class="links"><a href="http://archiveteam.org/index.php?title=Gov-FTP">Website</a> &middot;
